// Rutas del Exercise Tracker, aisladas en un Router.
...
// Se guarda como ISO (yyyy-mm-dd), que ordena y compara bien como texto, y se
// convierte al formato pedido solo al responder. Guardar ya formateado haria
// imposible filtrar por rango.
//
...
// siempre con componentes locales, nunca con toISOString ni con sufijo Z.
...
router.get('/api/users/:_id/logs', (req, res) => {
  ...
  // La consulta se arma por partes para no interpolar valores en el SQL: cada
  // filtro agrega su condicion y su parametro. Concatenar los valores
